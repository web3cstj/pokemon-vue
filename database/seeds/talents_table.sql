...
INSERT INTO `talents` (id,generation,nom_fr,nom_en,effet_combat,effet_terrain) VALUES (1,3,'Absentéisme','Truant','Le Pokémon n''attaque qu''un tour sur deux.',NULL),
 ...
 (4,3,'Agitation','Hustle','Statistiques : Augmente l''attaque de 50% mais baisse la précision de 20%.','Augmente de 50% les chances de rencontrer un Pokémon sauvage de haut niveau.'),
 ...
 (18,3,'Corps Ardent','Flame Body','30% de chance de provoquer une brûlure sur le Pokémon adverse ayant attaqué.','Divise par deux le nombre de pas nécessaire à l''éclosion d''un œuf.'),
 ...
 (26,3,'Écran Fumée','White Smoke','Empêche la diminution de statistiques par le Pokémon adverse.','Réduit de 50% les chances d''être attaqué par un Pokémon sauvage.'),
 ...
 (29,3,'Esprit Vital','Vital Spirit','Empêche le Pokémon d''être endormi.','Augmente de 50% les chances de rencontrer un Pokémon sauvage de haut niveau.'),
 (30,3,'Essaim','Swarm','Augmente la puissance des attaques de type Insecte de 50% lorsque le Pokémon a moins d''1/3 de ses PV totaux.','Augmente les chances d''entendre le cri d''un Pokémon sauvage.'),
 ...
 (36,3,'Glue','Sticky Hold','Empêche la perte de l''objet tenu.','Facilite la capture des Pokémon pêchés.'),
 ...
 (40,3,'Intimidation','Intimidate','Statistiques : Diminue d''un niveau l''attaque du Pokémon adverse.','Réduit de 50% les chances d''être attaqué par un Pokémon sauvage de bas niveau.'),
 (41,3,'Isograisse','Thick Fat','Les dégâts provoqués par les attaques des types Feu ou Glace sont divisés par 2.',NULL),
 (42,3,'Joli Sourire','Cute Charm','A 30% de chance de provoquer l''attirance du Pokémon adverse ayant attaqué.','Augmente de 50% les chances d''être attaqué par un Pokémon sauvage du sexe opposé.'),
 ...
 (45,3,'Magnépiège','Magnet Pull','Empêche la fuite et le changement des Pokémon de type Acier.','Augmente de 50% les chances de rencontrer un Pokémon sauvage de type Acier.'),
 ...
 (53,3,'Œil Composé','Compoundeye','Statistiques : Double la précision du Pokémon.','Augmente les chances de rencontrer un Pokémon sauvage tenant un objet.'),
 (54,3,'Paratonnerre','Lightningrod','Attire toutes les attaques de type Électrik. À partir de la 5ème génération, ce talent augmente aussi l''Attaque Spéciale du Pokémon recevant l''attaque.','Augmente les chances de recevoir un appel sur le PokéNav.'),
 (55,3,'Peau Dure','Rough Skin','Fait perdre 1/16è des PV du Pokémon adverse ayant lancé une attaque de contact.',NULL),
 (56,3,'Piège','Arena Trap','Empêche la fuite et le changement du Pokémon adverse, s''il est au sol.','Augmente de 50% les chances d''être attaqué par un Pokémon sauvage.'),
 ...
 (60,3,'Pression','Pressure','Double l''utilisation de PP des attaques offensives du Pokémon adverse.','Augmente de 50% les chances d''être attaqué par un Pokémon sauvage.'),
 ...
 (63,3,'Regard Vif','Keen Eye','Statistiques : Empêche la perte de précision.','Réduit de 50% les chances d''être attaqué par un Pokémon sauvage de bas niveau.'),
 ...
 (67,3,'Statik','Static','30% de chance de provoquer la paralysie du Pokémon adverse ayant lancé une attaque de contact.','Augmente de 50% les chances de rencontrer un Pokémon sauvage de type Électrik.'),
 (68,3,'Suintement','Liquid Ooze','Les attaques absorbantes du Pokémon adverse lui font perdre des PV.',NULL),
 (69,3,'Synchro','Synchronize','Toute altération d''état subie est transmise au Pokémon adverse.','Augmente les chances de rencontrer un Pokémon sauvage ayant la même nature.'),
 ...
 (76,3,'Ventouse','Suction Cups','Empêche d''être changé de force par une attaque adverse.','Augmente les chances qu''un Pokémon pêché morde à l''hameçon.'),
 (77,3,'Voile Sable','Sand Veil','Statistiques : Augmente l''esquive de 20% lors d''une tempête de sable et immunise contre ses dégâts.','Réduit de 50% les chances d''être attaqué par un Pokémon sauvage lors d''une tempête de sable.'),
